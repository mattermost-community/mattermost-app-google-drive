...
export async function createGoogleDocSubmit(call: ExtendedAppCallRequest): Promise<string> {
    ...
    const newDoc = await tryPromise<Schema$Document>(docs.documents.create(params), ExceptionType.TEXT_ERROR, i18nObj.__('general.google-error'), mattermostUrl);
    ...
    const file = await tryPromise<Schema$File>(drive.files.get(paramExport), ExceptionType.TEXT_ERROR, i18nObj.__('general.google-error'), mattermostUrl);
...
export async function createGoogleSlidesSubmit(call: ExtendedAppCallRequest): Promise<string> {
    ...
    const newSlide = await tryPromise<Schema$Presentation>(slides.presentations.create(params), ExceptionType.TEXT_ERROR, i18nObj.__('general.google-error'), mattermostUrl);
...
export async function createGoogleSheetsSubmit(call: ExtendedAppCallRequest): Promise<string> {
    ...
    const newSheets = await tryPromise<Schema$Spreadsheet>(sheets.spreadsheets.create(params), ExceptionType.TEXT_ERROR, i18nObj.__('general.google-error'), mattermostUrl);
